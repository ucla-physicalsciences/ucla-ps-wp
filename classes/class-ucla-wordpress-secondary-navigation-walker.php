...
class Ucla_Wordpress_Secondary_Navigation_Walker extends Walker_Nav_Menu
{
  ...
  function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
  {
    if ($args->has_children && $depth == 0) {
      ...
      $item->classes[] = 'ucla-secondary-nav__item--has-children';
    ...
    $link_attribute .= ' class="ucla-secondary-nav__link' . (in_array("current_page_item", $item->classes) || in_array("current-menu-parent", $item->classes) ? ' ucla-secondary-nav__link--current-page' : '') . '"';
    ...
    //   $item_output .= '<button class="ucla-secondary-nav__toggle" aria-expanded="false" aria-label="toggle"><svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="12 17.2 24 14.8"><title>Arrow Down</title><path class="down-arrow--blue" d="m14.8 17.2 9.2 9.2 9.2-9.2L36 20 24 32 12 20l2.8-2.8z"></path></svg></button>';
    // }
  ...
  function start_lvl(&$output, $depth = 0, $args = array())
  {
    ...
    $output .= "\n<ul class=\"ucla-secondary-nav__sublist\">$indent</li>\n";
  }
