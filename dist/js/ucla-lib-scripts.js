(() => {
  ...
  // js/vendors/splide/splide.js
  var require_splide = __commonJS({
    "js/vendors/splide/splide.js"(exports) {
      "use strict";
      ...
      document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll("th").forEach((el) => {
          el.addEventListener("click", function() {
            ...
            if (this.classList.contains("ucla-sortable") && this.querySelector("svg")) {
  ...
  var require_tabs = __commonJS({
    "js/tabs.js"() {
      "use strict";
      document.addEventListener("DOMContentLoaded", function() {
        const tabs = document.querySelectorAll(".ucla-tabs");
        for (let i = 0; i < tabs.length; i++) {
          const tabButtons = tabs[i].querySelectorAll(".ucla-tablink");
          const tabPanels = tabs[i].querySelectorAll(".ucla-tabpanel");
