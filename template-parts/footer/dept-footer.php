...
<div class="ucla-dept-footer__container">
  <img alt="" class="ucla-dept-footer__logo" src="<?php echo get_template_directory_uri(); ?>/img/logo-ucla.svg">
  <div class="ucla-dept-footer__body">
    <div class="ucla-dept-footer__info">
      ...
      <ul class="ucla-social">
        <?php
        if (myprefix_get_theme_option('facebook_input') !== NULL) {
          $facebook = myprefix_get_theme_option('facebook_input');
        ?>
          <li class="ucla-social__item">
            <a href="<?php echo $facebook ?>" class="ucla-social__link">
...
<!--
    <nav class="ucla-dept-footer__tertiary-nav">
      <div class="ucla-dept-footer__nav-column">
        <h6 class="tertiary-nav-header">Column Heading</h6>
      ...
      <div class="ucla-dept-footer__nav-column">
        <h6 class="tertiary-nav-header">Column Heading</h6>
        <ul class="ucla-dept-footer__nav">
          <li><a href="#" target="_blank">An External Link</a></li>
          <li><a href="#">A Link</a></li>
        </ul>
      </div>
      <div class="ucla-dept-footer__nav-column">
